...
No library-specific provider is required for this conventional model shape. Use `provideFormNodeControl()` only when unusual metadata prevents automatic discovery.
