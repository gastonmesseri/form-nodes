---
title: Advanced custom controls
---
...
This page covers alternative control contracts, state inputs and hooks, Angular `[formField]`
interoperability, detailed CVA behavior, wrappers, and compatibility boundaries.
