...
- The npm package is now named `@ngblocks/form-nodes`. Install it and update imports and module augmentations to the scoped name; the repository and documentation URLs remain the same.
