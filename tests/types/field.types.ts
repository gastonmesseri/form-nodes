...
type _FieldNodeType = Expect<Equal<ReturnType<typeof inferred.nodeType>, 'field'>>;
...
type _InferredValue = Expect<Equal<ReturnType<typeof inferred>, string>>;
...
type _ExplicitValue = Expect<Equal<ReturnType<typeof explicit>, number | undefined>>;
...
type _ApiValue = Expect<Equal<ReturnType<typeof inferred.$api.value>, string>>;
type _StableApiValue = Expect<Equal<ReturnType<typeof inferred.$api.value>, string>>;
type _Minimum = Expect<Equal<ReturnType<typeof inferred.min>, string | null>>;
type _Maximum = Expect<Equal<ReturnType<typeof nonNullable.max>, string | null>>;
type _MinimumLength = Expect<Equal<ReturnType<typeof inferred.minLength>, number | null>>;
type _MaximumLength = Expect<Equal<ReturnType<typeof inferred.maxLength>, number | null>>;
type _Patterns = Expect<Equal<ReturnType<typeof inferred.pattern>, readonly RegExp[]>>;
type _RootKeyInParent = Expect<Equal<ReturnType<typeof inferred.keyInParent>, string | number | null>>;
type _StandaloneRoot = Expect<Equal<ReturnType<ReturnType<typeof inferred.root>['nodeType']>, 'field' | 'form' | 'group' | 'array'>>;
type _DisabledReasons = Expect<Equal<ReturnType<typeof inferred.disabledReasons>, readonly DisabledReason[]>>;
type _NoInternalParentSetter = Expect<Equal<HasKey<typeof inferred, '_setParent'>, false>>;
type _NoInternalClone = Expect<Equal<HasKey<FieldApi<string | null>, '_clone'>, false>>;

inferred.set('Daniel');
explicitlyNullable.set(null);
...
inferred.update((value) => value?.toUpperCase() ?? null);
inferred.reset();
inferred.reset('Daniel');
inferred.focus({ preventScroll: true });
inferred.disable('Managed externally');
inferred.errors()[0]?.formNode?.focus({ preventScroll: true });
inferred.errors()[0]?.formNode?.element.focus();
