...
type _Minimum = Expect<Equal<ReturnType<typeof nullable.min>, string | undefined>>;
type _Maximum = Expect<Equal<ReturnType<typeof nonNullable.max>, string | undefined>>;
type _MinimumLength = Expect<Equal<ReturnType<typeof nullable.minLength>, number | undefined>>;
type _MaximumLength = Expect<Equal<ReturnType<typeof nullable.maxLength>, number | undefined>>;
